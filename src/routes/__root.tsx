...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Brushly" },
      { property: "og:title", content: "Brushly — Premium Painting Services" },
      { property: "og:description", content: "Book trusted painters in minutes. Affordable, fast & guaranteed." },
